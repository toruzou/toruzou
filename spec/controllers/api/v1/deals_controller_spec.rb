  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deal" do
        ...
        Deal.any_instance.should_receive(:update).with({ "amount" => 100 })
        put :update, {:id => deal.to_param, :deal => { "amount" => 100 }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the deal as @deal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Deal.any_instance.stub(:save).and_return(false)
        put :update, {:id => deal.to_param, :deal => { "amount" => -1 }}, valid_session
        assigns(:deal).should eq(deal)
      end
