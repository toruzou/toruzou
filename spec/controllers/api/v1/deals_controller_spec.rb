...
describe Api::V1::DealsController do
  ...
  let(:valid_attributes) { { "pj_type" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deal as @deal" do
        ...
        post :create, {:deal => { "pj_type" => "invalid value" }}, valid_session
        assigns(:deal).should be_a_new(Deal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deal" do
        ...
        Deal.any_instance.should_receive(:update).with({ "pj_type" => "MyString" })
        put :update, {:id => deal.to_param, :deal => { "pj_type" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the deal as @deal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Deal.any_instance.stub(:save).and_return(false)
        put :update, {:id => deal.to_param, :deal => { "pj_type" => "invalid value" }}, valid_session
        assigns(:deal).should eq(deal)
      end
